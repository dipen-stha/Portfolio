...
export const BentoGrid = ({
  ...
  return (
    <div
      className={cn(
        "grid grid grid-cols-1 md:grid-cols-6 lg:grid-cols-5 md:grid-row-7 gap-4 lg:gap-8 mx-autogrid-cols-1 md:grid-cols-3 gap-4 max-w-7xl mx-auto ",
        className
      )}
    >
      {children}
...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("dipenstha00@gmail.com");
  };
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor:
          "linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(85,90,170,0.8491879350348028) 35%, rgba(0,212,255,1) 100%)",
      }}
    >
